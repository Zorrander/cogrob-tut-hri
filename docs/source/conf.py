# -*- coding: utf-8 -*-
#
# Human-Robot Interactive Learning documentation build configuration file, created by
...
htmlhelp_basename = 'Human-RobotInteractiveLearningdoc'
...
latex_documents = [
    (master_doc, 'Human-RobotInteractiveLearning.tex', u'Human-Robot Interactive Learning Documentation',
     u'Cognitive Robotics TUT', 'manual'),
]
...
man_pages = [
    (master_doc, 'human-robotinteractivelearning', u'Human-Robot Interactive Learning Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Human-RobotInteractiveLearning', u'Human-Robot Interactive Learning Documentation',
     author, 'Human-RobotInteractiveLearning', 'One line description of project.',
     'Miscellaneous'),
]
